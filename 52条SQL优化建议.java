...
MarkerHub  lv-4
2022年02月14日 14:46 ·  阅读 9564


1， 对查询进行优化，'应尽量避免全表扫描'，首先应'考虑在 where 及 order by 涉及的列上建立索引'。
2，应尽量'避免'在 where 子句中对字段'进行 null 值判断'，创建表时'NULL是默认值'，但'大多数时候应该使用NOT NULL'，
或者使用一个特殊的值，如'0，-1'作为默 认值。

    lincq: 相当于没有发挥到索引的作用

3，应尽量避免在 where 子句中使用!=或<>操作符， MySQL'只有对以下操作符'才使用索引：<，<=，=，>，>=，BETWEEN，IN，以及某些时候的LIKE。
...
视频讲解： www.bilibili.com/video/BV1Jq…
完整开发文档：www.zhuawaba.com/post/124
线上演示：www.zhuawaba.com/dailyhub
【VueAdmin】手把手教你开发SpringBoot+Jwt+Vue的前后端分离后台管理系统

800分钟完整视频讲解：www.bilibili.com/video/BV1af…
完整开发文档前端：www.zhuawaba.com/post/18
完整开发文档后端：www.zhuawaba.com/post/19
【VueBlog】基于SpringBoot+Vue开发的前后端分离博客项目完整教学

200分钟完整视频讲解：www.bilibili.com/video/BV1af…
完整开发文档：www.zhuawaba.com/post/17
...
用户9633304534103
9天前
搬也不搬新一点的，搬别人18年的残羹冷炙，掘金现在水文的比贴吧还多
点赞
2

云上的云
4天前
有啥好的程序员交流网站推荐吗[不失礼貌的微笑]
点赞
回复
...
iRust
12天前
or 并不一定导致全表扫描 order by 也不一定会全表扫描
1
回复
ethanlife的头像
ethanlife
